...
PARAMETER {
    ...
    temperature = 36
    q10 = 2.1                   : q10 based on Otis and Mody 1992 - Referenced in Destexhe book
    exptemp = 34    (degC)      : exptemp based on Otis and Mody 1992 (33-35 degC) - Referenced in Destexhe book
}
