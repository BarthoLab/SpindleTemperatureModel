...
#define nca nca_iar
 double nca = 4;
#define temperature temperature_iar
...
#define taum taum_iar
 ...
 "temperature_iar", &temperature_iar,
 "cac_iar", &cac_iar,
 "k2_iar", &k2_iar,
 "Pc_iar", &Pc_iar,
 "k4_iar", &k4_iar,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 iar C:/Users/dburka/Dropbox/shared/matlab/dburka/+NetworkSim/@Sim/Ih.mod\n");
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  ...
  p0 = p00;
 {
   tadj = pow( 3.0 , ( ( temperature - 36.0 ) / 10.0 ) ) ;
   evaluate_fct ( _threadargscomma_ v , cai ) ;
   c1 = 1.0 ;
   o1 = 0.0 ;
   o2 = 0.0 ;
