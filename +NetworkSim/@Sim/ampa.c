...
#define Rinf Rinf_AMPA_S
 double Rinf = 0;
#define exptemp exptemp_AMPA_S
 double exptemp = 32;
#define q10 q10_AMPA_S
 double q10 = 2.4;
#define temperature temperature_AMPA_S
...
#define usetable usetable_AMPA_S
 ...
 "temperature_AMPA_S", &temperature_AMPA_S,
 "q10_AMPA_S", &q10_AMPA_S,
 "exptemp_AMPA_S", &exptemp_AMPA_S,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 2;
 	...
 	ivoc_help("help ?1 AMPA_S C:/Users/dburka/Dropbox/shared/matlab/dburka/+NetworkSim/@Sim/ampa.mod\n");
