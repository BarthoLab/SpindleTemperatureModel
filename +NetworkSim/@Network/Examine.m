function Examine(obj)
    ...
    PlotConnectionMatrix();
    
    function PlotConnectionMatrix()
        % Line colors
        % dark = [.3 .3 .3]; light = [.8 .8 .8];
        dark = [0 0 0]; light = [0 0 0];

        connectionMatrix = full(adjacency(obj.NetworkGraph));    
        h = imshow(connectionMatrix, 'InitialMagnification', 'fit');    
